...
<?= $this->section('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <form method="GET" action="<?=base_url('Voucher/index');?>">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row" style="margin-top:50px">
                        <div class="col-md-3">
                            <a href="<?= base_url('Voucher/New') ?>" class="btn btn-lg btn-success waves-effect waves-light"><i class="mdi mdi-plus" style="margin-right:10px"></i>Add Entry</a>
                        </div>
                    </div>
                            ...
                            <table id="qaListTable" class="table  table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%" style="vertical-align: middle;">DISC (%)</th>
                                        <th width="10%" style="vertical-align: middle;">START</th>
                                        <th width="10%" style="vertical-align: middle;">END</th>
                                ...
                                <tbody>
                                    <?php if(sizeof($datalist)!=0):?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?= date("d-m-Y", strtotime($row['expired_date_start'])) ?>
                                            </td>
                                            <td>
                                                <?= date("d-m-Y", strtotime($row['expired_date_end'])) ?>
                                            </td>
                                            <td>
                                                <?php if($row['status']==1):?>
                                            ...
                                            <td>
                                                <div class="button-items">
                                                    <a title="Detail" class="btn btn-primary waves-effect waves-light" href="<?= base_url('Voucher/Detail/'.$row['vcr_id']) ?>">
                                                    <i class="mdi mdi-information"></i>
                                                    </a>
                                                    <a title="Edit" class="btn btn-warning waves-effect waves-light" href="<?= base_url('Voucher/Edit/'.$row['vcr_id']) ?>">
                                                    <i class="mdi mdi-lead-pencil"></i>
                                                    </a>
                                                    <?php if($row['status']==1):?>
                                                        <button type="button" data-href="<?= base_url('Voucher/Delete/'.$row['vcr_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-danger waves-effect waves-light">
                                                        <i title="Active/Non-Active" class="mdi mdi-trash-can"></i>
                                                        </button>
                                                    <?php else:?>
                                                        <button type="button" data-href="<?= base_url('Voucher/Delete/'.$row['vcr_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-success waves-effect waves-light">
