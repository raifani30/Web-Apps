...
<head>
    ...
    <title>Artisan Seller Page</title>
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url('Product/Index')?>" class="waves-effect"><i class="mdi mdi-file-document-box-multiple-outline"></i><span>Product</span></a>
                        </li>
                        <li>
                            <a href="<?= base_url('Voucher/Index')?>" class="waves-effect"><i class="mdi mdi-flash"></i><span>Voucher</span></a>
                        </li>
                    </ul>
        ...
        <div class="content-page">
            ...
            <footer class="footer">© 2022 Artisan Seller Page</footer>
