...
<?= $this->section('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title" style="margin-bottom:20px">Detail Expedition | <span class="sub-title"><?= $data->exp_id ?></span></h4>
                    
                        <input type="hidden" name="id_qa" value="<?= $data->exp_id ?>" />
                        <div class="row" style="margin-bottom:50px">
                            <div class="col-md-4">
                                <dt>EXPEDITION NAME</dt>
                                <dd class="sub-title"><?= $data->exp_name ?></dd>
                                <dt>STATUS</dt>
                                <dd class="sub-title">
                        ...
                        <a href="<?= base_url('Expedition/Index');?>" class="btn btn-secondary mb-2">Back</a>
                </div>
            </div>
        </div>
        <!-- end col -->
