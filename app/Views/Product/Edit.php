...
<?= $this->section('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">EDIT | <span class="sub-title"><?= $data['prd_id'] ?></span></h4>
                    <a href="<?= base_url('Product/Index');?>" class="btn btn-sm btn-outline-secondary mb-2">Back</a>
                    <?php $validation = \Config\Services::validation(); ?>
                    <div style="margin-top:50px">
                    <form id="formUpdate" method="post" action="<?= base_url('Product/Update') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" style="padding-top:20px" id="detailtable">
                                <table class="table table-bordered" id="crud_table">
                                    ...
                                    <?php foreach ($variation as $s) : ?>
                                        <tr>
                                            <td hidden class="variation_id"><?= $s['prd_dtl_id'] ?></td>
                                            <td contenteditable="true" class="variation_name"><?= $s['variation_name'] ?></td>
                                            <td contenteditable="true" class="variation_qty numeric"><?= $s['stock'] ?></td>
                                            <td contenteditable="true" class="variation_price numeric"><?= $s['price'] ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
                            </div>
                        ...
                        <div class="form-group">
                            <button id="btnSave" type="submit" class="btn btn-info waves-effect waves-light">Update</button>
                        </div>
                    </form>
                    </div>
                </div>
    ...
    $('#add').click(function() {
        ...
        html_code += "<td hidden class='variation_id'>0</td>";
