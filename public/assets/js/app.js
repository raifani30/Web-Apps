...
!function($) {
    ...
    MainApp.prototype.initActiveMenu = function () {
        ...
        $("#sidebar-menu a").each(function () {
            ...
            var pageUrlCleaned = pageUrl.slice(0, pageUrl.lastIndexOf('/'));
            var hrefUrlCleaned = this.href.slice(0, this.href.lastIndexOf('/'));
            
            //console.log(pageUrlCleaned +'  |  ' + hrefUrlCleaned);
            if (hrefUrlCleaned == pageUrlCleaned) {
